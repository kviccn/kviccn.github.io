import{_ as t}from"./plugin-vue_export-helper-c27b6911.js";import{r as o,o as i,c as l,b as s,d as n,e as a,w as d,a as p}from"./app-a3b1dd03.js";const r="/assets/boot1-b6ec2776.jpg",u={},v=s("code",null,"数据结构",-1),m=s("code",null,"全局描述符表",-1),b=s("code",null,"段描述符",-1),k=s("code",null,"GDTR",-1),f=s("code",null,"C 语言",-1),x=s("code",null,"struct",-1),h=s("code",null,"汇编语言",-1),g=s("code",null,"C 语言",-1),_=p(`<h2 id="预处理" tabindex="-1"><a class="header-anchor" href="#预处理" aria-hidden="true">#</a> 预处理</h2><p>先来教大家一个技巧，在<code>汇编语言</code>中使用<code>预处理</code>。改造上一篇文章中的示例代码。</p><h3 id="代码" tabindex="-1"><a class="header-anchor" href="#代码" aria-hidden="true">#</a> 代码</h3><div class="language-asm line-numbers-mode" data-ext="asm"><pre class="language-asm"><code># filename - boot.S
